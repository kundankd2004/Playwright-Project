...
- Name: myInfo.spec.js >> My Info URL Validation Test @regression
- Location: tests/myInfo.spec.js:36:1
...
> 53  |     await page.getByText('My Info').click();
  ...
  129 |         '(//input[@class="oxd-input oxd-input--active"])[2]'
  130 |     );
  131 | 
  132 |     await expect(employeeIdField).toBeVisible();
  133 | 
  134 | });
  135 | 
  136 | test('Save Button Visibility Test @sanity', async ({ page, loginPage }) => {
  137 | 
  138 |     Logger.info('Starting Save Button Visibility Test');
  139 | 
  140 |     await page.goto(
  141 |         'https://opensource-demo.orangehrmlive.com/web/index.php/auth/login',
  142 |         {
  143 |             waitUntil: 'domcontentloaded',
  144 |             timeout: 60000
  145 |         }
  146 |     );
  147 | 
  148 |     await loginPage.login(
  149 |         process.env.APP_USERNAME,
  150 |         process.env.APP_PASSWORD
  151 |     );
  152 | 
  153 |     await page.getByText('My Info').click();
```